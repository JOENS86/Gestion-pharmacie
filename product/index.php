...
<body>
 	 	<form method="POST" action="register.php?numero_facture=<?php echo $_GET['numero_facture']?>">
  	  	  <table id="table" style="width: 400px; margin: auto;overflow-x:auto; overflow-y: auto;">
  	  	 <tr>
         <td>Code Bar</td>
         <td><input type="text" name="bar_code" id="bar_code" size="10" placeholder="Mettez votre curseur ici"></td>
          </tr>
          <tr id="row1">
        ...
        <tr>
          <td></td>
          <td> <input type="submit" name="submit" class="btn btn-primary btn-large" style="width: 225px" value="Sauvegarde"> </td>
        </tr>
